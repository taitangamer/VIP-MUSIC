...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        image2 = Image.open(f"assets/{images}.png")
        ...
        draw.text((190, 650), f"Powere Taitangamer(@taitangamer)", (255, 255, 255), font=font)
        try:
            os.remove(f"cache/thumb{videoid}.png")
...
async def gen_qthumb(videoid, user_id):
    ...
    try:
        ...
        draw.text((190, 570), f"Duration: {duration}", (255, 255, 255), font=font)
        draw.text((190, 610), f"Views: {views}", (255, 255, 255), font=font)
        draw.text((190, 650), f"Powered By: 𝐓𝐚𝐢𝐭𝐚𝐧 (@taitangamerz @taitangamer)", (255, 255, 255), font=font)
        try:
            os.remove(f"cache/thumb{videoid}.png")
            os.remove(f"cache/temp.png")
        except:
